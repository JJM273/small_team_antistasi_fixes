// fn_artySupport.sqf
// Override of A3A_fnc_artySupport
// Changes from original:
//   1. Role gate: allows FOs (UID in STA_foPlayers) in addition to theBoss
...
// ── STA: trigger post-fire monitor on server for each battery that fired ──────
